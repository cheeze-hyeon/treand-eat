...
export default function MapMetricToggle({ mode, onChange }: MapMetricToggleProps) {
  return (
    <div
      className="flex flex-col w-[108px] overflow-hidden rounded-lg bg-[#f2efe9] pointer-events-auto"
      role="group"
      aria-label="지도 표시 지표"
    >
      <button
        ...
        className={`px-2.5 py-1.5 rounded-md text-[13px] text-center transition-colors ${
