...
function Container1() {
 ...
 <p className="[word-break:break-word] font-bold leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px] whitespace-nowrap">3 / 4</p>
 </div>
 </div>
 </div>
 );
...
function Container4() {
 return <div className="bg-[#2e211c] h-[8px] relative rounded-[22369600px] shrink-0 w-[256px]" data-name="Container" />;
}
...
function Heading() {
 ...
 <p className="-translate-x-1/2 absolute font-bold leading-[36px] left-[176px] text-[#2e211c] text-[30px] top-0 w-[342px]">끌리는 맛을 골라주세요</p>
 <div className="-translate-x-1/2 absolute leading-[0] left-[171px] text-[#665a55] text-[16px] top-[44px] w-[342px]">
 <p className="leading-[20px] mb-0">단짠, 고소함, 쌉싸름까지</p>
...
function Frame() {
 ...
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">달콤한</p>
 </div>
 );
}
...
function Frame1() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">매콤한</p>
 </div>
 );
}
...
function Frame2() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">고소한</p>
 </div>
 );
}
...
function Frame3() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">매운</p>
 </div>
 );
}
...
function Frame4() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">시큼한</p>
 </div>
 );
}
...
function Frame5() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">쌉싸름한</p>
 </div>
 );
}
...
function Frame6() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">짭짜름한</p>
 </div>
 );
}
...
function Frame7() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">담백한</p>
 </div>
 );
}
...
function Frame8() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">진한</p>
 </div>
 );
}
...
function Frame9() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">가벼운</p>
 </div>
 );
}
...
function Frame10() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">상큼한</p>
 </div>
 );
}
...
function Frame11() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">느끼한</p>
 </div>
 );
}
...
function Frame12() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">슴슴한</p>
 </div>
 );
}
...
function Frame13() {
 ...
 <div aria-hidden="true" className="absolute border-2 border-[#665a55] border-solid inset-0 pointer-events-none rounded-[5px]" />
 <p className="[word-break:break-word] font-bold leading-[26px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">자극적인</p>
 </div>
 );
}
...
function Frame14() {
 return (
 <div className="absolute gap-x-[13px] gap-y-[12px] grid-cols-[repeat(2,fit-content(100%))] grid-rows-[repeat(7,fit-content(100%))] inline-grid left-[54px] top-[113px]">
 <Frame />
 <Frame1 />
 <Frame2 />
 <Frame3 />
...
export default function Component() {
 return (
 <div className="bg-white relative size-full" data-name="온보딩 9">
 <Container />
 </div>
 );
}